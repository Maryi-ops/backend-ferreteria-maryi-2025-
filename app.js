...
import rutasDetalleCompras from  './src/routes/detalles_compras.routes.js';
import rutasDetalleVentas from './src/routes/detalles_ventas.routes.js';
...
app.use(express.json({ limit: '10mb' })); //18 MB
